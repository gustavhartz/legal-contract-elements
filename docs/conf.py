# -*- coding: utf-8 -*-
#
# legal-contract-elements documentation build configuration file, created by
# sphinx-quickstart.
#
...
project = u'legal-contract-elements'
...
latex_documents = [
    ('index',
     'legal-contract-elements.tex',
     u'legal-contract-elements Documentation',
     u"Gustav Hartz", 'manual'),
]
